// submission-guard.js
// Inclua este arquivo nas páginas do quiz (ex: <script src="/src/js/submission-guard.js" defer></script>)
...
(function () {
  ...
  function showSubmittedNotice(container) {
    ...
    msg.textContent = 'Você já submeteu este questionário. As respostas não podem mais ser alteradas.';
